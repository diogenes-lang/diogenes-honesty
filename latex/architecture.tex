...
We sketch the architecture of our tools in~\Cref{fig:architecture}.
...
%\paragraph{Diogenes.}
The Java honesty checker is built on top of \emph{Java PathFinder}
...
% method invocations, which correspond to 
...
%
Through JPF we symbolically executes and backtracks the program, % multiple times,
