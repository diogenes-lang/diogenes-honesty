...
\hidden{
The code is very simple and it is trivial to understand what represents
each line.
To better fill implementation specific constrains,
the user can, for example, define the methods 
\code{isValid(String order):boolean} and 
\code{getAmount(String order):int}.
}
\subsection{Honesty verification}
