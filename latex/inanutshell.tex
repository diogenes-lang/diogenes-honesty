...
if the distributor response arrives after the timeout (line \lineno{10}),
...
We use Java exceptions to model both the \inlineCoco{tellRetract} 
...
Moreover, the order amount at line \lineno{15} is hardcoded, 
