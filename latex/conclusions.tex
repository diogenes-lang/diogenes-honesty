...
exploiting the EMF (Eclipse Modelling Framework)
as common data layer.

Regarding to Diogenes, we are trying to extend
the verification technique to \emph{timed} session
types~\cite{Bartoletti15forte}, already supported by the contract-oriented middleware of \cite{CO2middleware}. 
Future versions of Diogenes may also provide 
