...
\FXRegisterAuthor{tizi}{antizi}{\color{green} {\underline{tizi}}}
\FXRegisterAuthor{maurizio}{anmaurizio}{\color{cyan} {\underline{maurizio}}}
...
\lstdefinelanguage{coco}{
	...
	morecomment=[s]{/*}{*/},
	classoffset=0,
	morekeywords={honesty,contract,process,system,if,then,else,nil,rec},
