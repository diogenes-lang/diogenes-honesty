...
\newcommand{\minus}{\scalebox{1}[1.5]{$-$}}
\newcommand{\coco}{CO\textsubscript{2}\xspace}
\newcommand{\cocosub}{CO\rlap{\textsubscript{2}}\textsuperscript{\minus}\xspace}
...
\newcommand{\tellretract}[2]{\cocoFmt{tell?}^{#1}\,{#2}}
\newcommand{\tellwait}[2]{\cocoFmt{tellAndWait}^{#1}\,{#2}}
\newcommand{\send}[1]{\cocoFmt{send}_{#1}\,}
\newcommand{\receive}[1]{\cocoFmt{receive}_{#1}\,}
\newcommand{\freeze}[2]{\downarrow_{#1}{#2}}
\newcommand{\ask}[2]{\ifempty{#2}{\cocoFmt{ask}_{{#1}}}{\cocoFmt{ask}_{{#1}}\,{#2}}}
\newcommand{\retract}[1]{\cocoFmt{retract}_{{#1}}}
...
\newcommand{\niconote}[1]{\textcolor{blue}{nico-note: #1}}
